...
const getClassListArray = (cell) => { //
  ...
  const getCellLocation = (cell) => { //
    ...
    const rowClass = classList.find(className => className.includes('row')); //las clases que incluyan
  ...
  const checkWinningCells = (cells) => {
    ...
    statusSpan.textContent = `${yellowIsNext ? 'Amarillo' : 'Rojo'} ha ganado xd`
    return true;
  };
